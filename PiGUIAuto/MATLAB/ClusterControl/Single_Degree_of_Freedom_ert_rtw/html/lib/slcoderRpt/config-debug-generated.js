...
dojoConfig.packages.push({'name': 'graphics_textutilities', 'location': '/toolbox/matlab/graphics/textutilities/textutilities'});
...
dojoConfig.packages.push({'name': 'mw-context-menu', 'location': '/derived/ui/mw-context-menu'});
...
dojoConfig.packages.push({'name': 'reusableDiagnosticViewer-lib', 'location': '/ui/reusableDiagnosticViewer/reusableDiagnosticViewer-lib'});
...
dojoConfig.packages.push({'name': 'studio-builder-js', 'location': '/toolbox/studio/builder-js/src'});
dojoConfig.packages.push({'name': 'studio-config-js', 'location': '/toolbox/studio/config-js/src'});
