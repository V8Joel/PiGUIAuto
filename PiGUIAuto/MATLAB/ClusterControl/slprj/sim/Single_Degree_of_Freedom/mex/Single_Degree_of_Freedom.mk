...
MAKECMD         = /Applications/MATLAB/MATLAB_R2023b.app/bin/maca64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = Single_Degree_of_Freedom
MODULES                 = Single_Degree_of_Freedom_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/Single_Degree_of_Freedom_msf.mexmaca64
MAKEFILE                = Single_Degree_of_Freedom.mk
MATLAB_ROOT             = /Applications/MATLAB/MATLAB_R2023b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB/MATLAB_R2023b.app
...
NCSTATES                = 0
COMPUTER                = MACA64
BUILDARGS               =  GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DIS_SIM_TARGET -DMATLAB_MEX_FILE -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=11.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,-rpath,/Applications/MATLAB/MATLAB_R2023b.app/bin/maca64 -Wl,-rpath,/Applications/MATLAB/MATLAB_R2023b.app/sys/os/maca64 -Wl,-rpath,@executable_path -Wl,-rpath,@executable_path/../../.. -L/Applications/MATLAB/MATLAB_R2023b.app/sys/os/maca64
INTERLEAVED_COMPLEX_FLAGS = -R2018a
DEFINES_CUSTOM          = 
DEFINES_OTHER           = -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMATLAB_DEFAULT_RELEASE=R2018a
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/Applications/MATLAB/MATLAB_R2023b.app/bin/maca64" -lfixedpoint -lmwmathutil -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lemlrt -lmx -lmex
...
MODELLIB                  = Single_Degree_of_Freedom_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/Single_Degree_of_Freedom/Single_Degree_of_Freedomlib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/Single_Degree_of_Freedom/Single_Degree_of_Freedomlib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/Single_Degree_of_Freedom/Single_Degree_of_Freedomlib.a -Wl,--end-group
endif
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/Single_Degree_of_Freedom \
...
Single_Degree_of_Freedom_msf.o : $(START_DIR)/slprj/sim/Single_Degree_of_Freedom/Single_Degree_of_Freedom_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/Single_Degree_of_Freedom/Single_Degree_of_Freedom_msf.c
