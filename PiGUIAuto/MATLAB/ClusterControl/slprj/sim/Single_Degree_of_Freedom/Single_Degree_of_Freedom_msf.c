...
#define S_FUNCTION_NAME Single_Degree_of_Freedom_msf
#endif
...
static void mdlInitializeConditions ( SimStruct * S ) { iinny4bxlm1 * dw = (
iinny4bxlm1 * ) ssGetDWork ( S , 0 ) ; bhfyobustz ( & ( dw -> rtdw ) ) ; }
static void mdlReset ( SimStruct * S ) { iinny4bxlm1 * dw = ( iinny4bxlm1 * )
ssGetDWork ( S , 0 ) ; amex2n5a4n ( & ( dw -> rtdw ) ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { iinny4bxlm1 * dw = (
iinny4bxlm1 * ) ssGetDWork ( S , 0 ) ; real_T const * i_owqfawj1eg = ( real_T
* ) ssGetInputPortSignal ( S , 0 ) ; real_T * o_B_1_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) { Single_Degree_of_Freedom
( & ( dw -> rtm ) , i_owqfawj1eg , o_B_1_1 , & ( dw -> rtb ) , & ( dw -> rtdw
) ) ; jsjjnjbsvs ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void
...
mr_Single_Degree_of_Freedom_RegisterSimStateChecksum ( S ) ;
...
mr_Single_Degree_of_Freedom_MdlInfoRegFcn ( S , "Single_Degree_of_Freedom" ,
& retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( iinny4bxlm1 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { iinny4bxlm1 * dw = (
iinny4bxlm1 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } iqvtcocchx
...
-> mdlInfo -> genericFcn ; } jbfq43jur5 ( & ( dw -> rtm ) , & ( dw -> rtdw )
) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { iinny4bxlm1 * dw = ( iinny4bxlm1 * ) ssGetDWork ( S , 0 )
; real_T const * i_owqfawj1eg = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { Single_Degree_of_Freedom ( & ( dw -> rtm ) ,
i_owqfawj1eg , o_B_1_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { iinny4bxlm1 * dw = (
iinny4bxlm1 * ) ssGetDWork ( S , 0 ) ; jsjjnjbsvs ( & ( dw -> rtb ) , & ( dw
-> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) {
iinny4bxlm1 * dw = ( iinny4bxlm1 * ) ssGetDWork ( S , 0 ) ; ieafoiptya ( & (
dw -> rtm ) ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { iinny4bxlm1 * dw =
( iinny4bxlm1 * ) ssGetDWork ( S , 0 ) ; oxj4tw1ap2 ( & ( dw -> rtm ) , & (
dw -> rtdw ) ) ; }
...
mdlrefDW = mr_Single_Degree_of_Freedom_GetDWork ( ssGetDWork ( S , 0 ) ) ;
...
mr_Single_Degree_of_Freedom_SetDWork ( ssGetDWork ( S , 0 ) ,
