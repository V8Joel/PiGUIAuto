...
MODULES                 = Single_Degree_of_Freedom.c Single_Degree_of_Freedom_capi.c
PRODUCT                 = Single_Degree_of_Freedomlib.a
...
NCSTATES                = 0
COMPUTER                = MACA64
BUILDARGS               =  GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DIS_SIM_TARGET -DMATLAB_MEX_FILE -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=11.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/Applications/MATLAB/MATLAB_R2023b.app/bin/maca64" -lfixedpoint -lmwmathutil -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lemlrt
...
MODELLIB                  = Single_Degree_of_Freedomlib.a
MODELREF_LINK_LIBS        = 
