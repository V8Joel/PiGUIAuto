...
MODEL                   = rtwshared
MODULES                 = rtGetInf.c rtGetNaN.c rt_nonfinite.c look1_binlxpw.c
PRODUCT                 = rtwshared.a
MAKEFILE                = 
...
NCSTATES                = 0
COMPUTER                = MACA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/Applications/MATLAB/MATLAB_R2023b.app" RSIM_PARAMETER_LOADING=1 OPTS="-DNRT -DIS_SIM_TARGET -DTGTCONN -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DON_TARGET_WAIT_FOR_START=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=11.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
