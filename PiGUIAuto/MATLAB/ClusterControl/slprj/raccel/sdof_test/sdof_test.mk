...
MODEL                   = sdof_test
MODULES                 = sdof_test.c sdof_test_capi.c sdof_test_data.c sdof_test_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = sdof_test
MAKEFILE                = sdof_test.mk
...
CLASSIC_INTERFACE       = 1
MODELREFS               = Single_Degree_of_Freedom 
GEN_SAMPLE_MAIN         = 0
TARGET_LANG_EXT         = c
SHRLIBTARGET            = 0
...
ADD_INCLUDES = \
	...
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/sdof_test \
