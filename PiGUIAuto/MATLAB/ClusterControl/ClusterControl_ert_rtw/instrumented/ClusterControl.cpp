...
namespace BenchTest
{
  ...
  void ClusterControl::Model_Step_100Hz()
  {
    ...
    profileStart_ClusterControl(1U); /* original_line:54 */ModelMDLOBJ1.step(&ClusterControl_B.Input, &ClusterControl_B.Displacement);profileEnd_ClusterControl(1U); /* original_line:54 */
  ...
  void ClusterControl::Initialize()
  {
    ...
    profileStart_ClusterControl(2U); /* original_line:99 */ModelMDLOBJ1.init();profileEnd_ClusterControl(2U); /* original_line:99 */
