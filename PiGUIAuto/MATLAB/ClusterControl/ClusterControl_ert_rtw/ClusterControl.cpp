...
namespace BenchTest
{
  ...
  void ClusterControl::Model_Step_10Hz()
  {
    ...
    qDebug() << "In Model_Step_10Hz";
    qDebug() << "ClusterControl_B.RPM_Raw:" << ClusterControl_B.RPM_Raw;
    qDebug() << "ClusterControl_Y.RPM_Out:" << ClusterControl_Y.RPM_Out;
  ...
  void ClusterControl::RPM_Update()
  {
    ...
    qDebug() << "In RPM_Update";
    qDebug() << "ClusterControl_B.RPM_In:" << ClusterControl_B.RPM_In;
  ...
  void ClusterControl::Initialize()
  {
    ...
    qDebug() << "Initial ClusterControl_Y.RPM_Out:" << ClusterControl_Y.RPM_Out;
    qDebug() << "Initial ClusterControl_B.RPM_In:" << ClusterControl_B.RPM_In;
  }
