...
#endif                                 /* SDOF_Test_COMMON_INCLUDES_ */
...
extern void SDOF_Test_initialize(void);
extern void SDOF_Test_step(void);
extern void SDOF_Test_terminate(void);

/* Real-time Model object */
extern RT_MODEL_SDOF_Test_T *const SDOF_Test_M;
 ...
 * '<Root>' : 'SDOF_Test'
 * '<S1>'   : 'SDOF_Test/SDOF'
 * '<S2>'   : 'SDOF_Test/SDOF/Discrete Derivative'
 */
#endif                                 /* RTW_HEADER_SDOF_Test_h_ */
